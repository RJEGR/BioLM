...
| 04 | `04_rope_y_alibi.ipynb` | **(Extensión)** Codificaciones posicionales modernas RoPE y ALiBi desde cero, experimento empírico de extrapolación a 2× y 4× la longitud de entrenamiento | 60–75 min (3 entrenamientos incluidos) |

## Bibliografía obligatoria asociada

* **Vaswani et al. (2017)** — *Attention Is All You Need*. NeurIPS 30. (Notebooks 01, 02, 03)
* **Ji et al. (2021)** — *DNABERT*. Bioinformatics 37(15):2112–2120. (Notebook 03)
* **Su et al. (2021)** — *RoFormer: Enhanced Transformer with Rotary Position Embedding*. arXiv:2104.09864. (Notebook 04)
* **Press et al. (2022)** — *Train Short, Test Long: Attention with Linear Biases Enables Input Length Extrapolation*. ICLR. (Notebook 04)
